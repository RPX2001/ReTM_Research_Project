...
dataset_path = "train_dataset_B_10_denoise"
valid_dataset_path = "valid_dataset_B_10_denoise"
...
class LogRatioLoss(nn.Module):
    ...
    def forward(self, predicted, target):
        ...
        predicted_img = predicted[3:6, :,:]
        predicted_real = predicted[0:3, :,:]
        target_img = target[3:6, :,:]
...
test_dataset_path = "test_dataset_B_10_denoise"
...
output = model(multichannel_audio)
output_img = output[3:6, :,:]
output_real = output[0:3, :,:]
